...
export const SCHOOLS: School[] = [
  ...
  },
  {
    ...
    clan: 'Clan du Scorpion',
    traitBonus: 'intuition',
  skills: ['Comédie', 'Courtoisie', 'Jiujutsu', 'Discrétion', 'Temptation', 'Tromperie'],
  technique: 'Masque du Scorpion : +1k1 aux jets de Tromperie et Comédie. Peut changer d\'identité sociale en une scène.',
    honor: 4.5,
  ...
  },
  {
    ...
    clan: 'Clan du Renard',
    traitBonus: 'agilite', 
  skills: ['Défense', 'Kenjutsu', 'Discrétion', 'Lore: Forêt', 'Survie'],
  technique: 'Ruse du Renard : +1k1 aux jets de Discrétion. Peut se déplacer en terrain difficile sans pénalité.',
    honor: 6.0,
  ...
  },
  {
    ...
    clan: 'Clan du Lièvre',
    traitBonus: 'reflexes',
  skills: ['Défense', 'Kenjutsu', 'Athlétisme', 'Discrétion', 'Équitation'],
  ...
  // Moines
  {
    ...
    clan: 'Clan du Dragon',
    traitBonus: 'agilite',
  skills: ['Athlétisme', 'Jiujutsu', 'Méditation', 'Lore: Théologie', 'Discrétion'],
  ...
  // Clan de l'Araignée
  {
    ...
    traitBonus: 'agilite',
  skills: ['Kenjutsu', 'Défense', 'Lore: Shadowlands', 'Discrétion', 'Intimidation', 'Jiujutsu', 'Athlétisme'],
  ...
  },
  {
    ...
    clan: 'Clan de l\'Araignée',
    traitBonus: 'intelligence',
  skills: ['Courtisan', 'Étiquette', 'Sincérité', 'Tentation', 'Lore: Underworld', 'Investigation', 'Comédie'],
