  ...
  template: `
    <div class="container">
      <ng-container *ngIf="auth.isAuthenticated(); else guest">
        <div class="lobby" *ngIf="!currentRoomId(); else roomView">
          <h2>Salon Multijoueur</h2>
          <p *ngIf="!multi.connected()" class="warning">⚠️ Connexion au serveur GM_L5R...</p>
          ...
          <mat-card class="rooms">
            ...
            <mat-list *ngIf="multi.publicRooms().length > 0; else noRooms">
              <mat-list-item *ngFor="let r of multi.publicRooms()">
                <div class="room-line">
                  <div class="info">
          ...
          <div class="columns">
            <mat-card class="chat">
              ...
              <div class="messages" #scrollMe>
                ...
                <div class="roll" *ngFor="let d of dice()">
            ...
            <mat-card class="tools">
              ...
              <div class="participants">
                ...
                <ul>
                  ...
                  <li *ngFor="let p of (currentRoom()?.players || [])">{{ p.name }} <span *ngIf="p.characterName">— {{ p.characterName }}</span></li>
                </ul>
              </div>
            </mat-card>
          </div>
